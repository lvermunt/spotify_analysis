...
def main():
    ...
    df_songs['c_unique_tr'] = df_songs.groupby('unique_tr')['unique_tr'].transform('count')
    df_songs['c_unique_ar'] = df_songs.groupby('artist_name')['artist_name'].transform('count')
    ...
    spotify_api_track.get_spotify_credentials(os.path.join(args.input, 'spotify_secret.yaml'))
